				...
				<div class="margin-top first">
						...
						<table class="table">
							<tbody>
								...
								<tr>
									<th>작성일</th>
									<td class="text-align-left text-indent" colspan="3"><fmt:formatDate pattern="yyyy년-MM월-dd일 hh:mm:ss" value="${n.regdate}"/></td>
								</tr>
								<tr>
									<th>작성자</th>
									<td>${n.writerId}</td>
									<th>조회수</th>
									<td><fmt:formatNumber type="numnber" pattern="#,####원" value="${n.hit}" /></td>
								</tr>
								<tr>
									<th>첨부파일</th>
